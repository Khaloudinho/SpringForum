...
public class ProjectController {
    ...
    @GetMapping("project/{projectId}/editproject")
    ...
    @PostMapping("project/{projectId}/editproject")
    public ModelAndView editPostProject(@PathVariable("projectId") String projectId) {
        ModelAndView modelAndView = new ModelAndView();
    ...
    public void addPermission(@PathVariable("projectId") Long projectId, @RequestParam("user") Long userId, @RequestParam("permission") String permission) {
